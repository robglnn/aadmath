...
// The escape instrument — ESCAPE_JS (what the page measures) and notFree()
// (the predicate over it) — lives in tools/critic/_escape.mjs so that this gate
// and tools/critic/compose.mjs ask the identical question with the identical
// bars. It moved there verbatim; nothing in the measurement changed.
